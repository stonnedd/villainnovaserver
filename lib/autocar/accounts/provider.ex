defmodule Autocar.Accounts.Provider do
  ...
  schema "providers" do
    ...
    field :ranking_values, {:array, :integer}	
  ...
  def changeset(%Provider{} = provider, attrs) do
    provider
    |> cast(attrs, [:company_name, :address, :brands, :lat, :lng, :map_icon, :aditional_phone, :ranking, :ranking_count, :schedule, :service, :specialty, :website, :is_active, :status, :user_id, :point, :ranking_values, :company_email])
    #|> validate_required([])
